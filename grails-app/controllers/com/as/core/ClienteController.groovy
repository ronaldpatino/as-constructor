...
class ClienteController {
    ...
    def agregarDireccion(Long id){
        println "Agregando Direccion: "+id
        redirect controller:'direccion', action:'agregarDireccionCliente',id:id
    }
